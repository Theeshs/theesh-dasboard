...
func (eq *EducationQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (eq *EducationQuery) FirstIDX(ctx context.Context) uint {
...
func (eq *EducationQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (eq *EducationQuery) OnlyIDX(ctx context.Context) uint {
...
func (eq *EducationQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (eq *EducationQuery) IDsX(ctx context.Context) []uint {
	ids, err := eq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(education.FieldInstitueName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Education.Query().
//		Select(education.FieldInstitueName).
//		Scan(ctx, &v)
