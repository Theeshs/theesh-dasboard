...
func (e SkillEdges) UserSkillAssociationOrErr() (*UserSkillAssociation, error) {
	if e.UserSkillAssociation != nil {
		return e.UserSkillAssociation, nil
	} else if e.loadedTypes[0] {
		return nil, &NotFoundError{label: userskillassociation.Label}
	}
...
func (s *Skill) QueryUserSkillAssociation() *UserSkillAssociationQuery {
	return NewSkillClient(s.config).QueryUserSkillAssociation(s)
}
