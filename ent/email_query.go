...
func (eq *EmailQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (eq *EmailQuery) FirstIDX(ctx context.Context) uint {
...
func (eq *EmailQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (eq *EmailQuery) OnlyIDX(ctx context.Context) uint {
...
func (eq *EmailQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (eq *EmailQuery) IDsX(ctx context.Context) []uint {
	ids, err := eq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//
//	client.Email.Query().
//		GroupBy(email.FieldCallBackEmail).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Email.Query().
//		Select(email.FieldCallBackEmail).
//		Scan(ctx, &v)
...
func (eq *EmailQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(email.Table, email.Columns, sqlgraph.NewFieldSpec(email.FieldID, field.TypeUint))
	_spec.From = eq.sql
