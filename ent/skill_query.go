...
func (sq *SkillQuery) QueryUserSkillAssociation() *UserSkillAssociationQuery {
	query := (&UserSkillAssociationClient{config: sq.config}).Query()
...
func (sq *SkillQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (sq *SkillQuery) FirstIDX(ctx context.Context) uint {
...
func (sq *SkillQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (sq *SkillQuery) OnlyIDX(ctx context.Context) uint {
...
func (sq *SkillQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (sq *SkillQuery) IDsX(ctx context.Context) []uint {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SkillQuery) Clone() *SkillQuery {
	...
	return &SkillQuery{
		...
		withUserSkillAssociation: sq.withUserSkillAssociation.Clone(),
...
func (sq *SkillQuery) WithUserSkillAssociation(opts ...func(*UserSkillAssociationQuery)) *SkillQuery {
	query := (&UserSkillAssociationClient{config: sq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	sq.withUserSkillAssociation = query
	return sq
}
...
func (sq *SkillQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Skill, error) {
	var (
		...
		_spec       = sq.querySpec()
		loadedTypes = [1]bool{
			sq.withUserSkillAssociation != nil,
		}
	)
	...
	if query := sq.withUserSkillAssociation; query != nil {
		if err := sq.loadUserSkillAssociation(ctx, query, nodes, nil,
			func(n *Skill, e *UserSkillAssociation) { n.Edges.UserSkillAssociation = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (sq *SkillQuery) loadUserSkillAssociation(ctx context.Context, query *UserSkillAssociationQuery, nodes []*Skill, init func(*Skill), assign func(*Skill, *UserSkillAssociation)) error {
