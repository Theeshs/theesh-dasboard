...
// The AlembicVersionFunc type is an adapter to allow the use of ordinary
// function as AlembicVersion mutator.
type AlembicVersionFunc func(context.Context, *ent.AlembicVersionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AlembicVersionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AlembicVersionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AlembicVersionMutation", m)
}
...
// The UserServiceFunc type is an adapter to allow the use of ordinary
// function as UserService mutator.
type UserServiceFunc func(context.Context, *ent.UserServiceMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserServiceFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserServiceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserServiceMutation", m)
}
