...
func (tx *Tx) init() {
	tx.AlembicVersion = NewAlembicVersionClient(tx.config)
	...
	tx.UserService = NewUserServiceClient(tx.config)
...
// applies a query, for example: AlembicVersion.QueryXXX(), the query will be executed
