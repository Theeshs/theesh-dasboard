...
type UserQuery struct {
	...
	withUserProjects          *UserProjectQuery
	withUserServices          *UserServiceQuery
	withUserSkillAssociations *UserSkillAssociationQuery
...
func (uq *UserQuery) QueryExperiences() *ExperienceQuery {
	query := (&ExperienceClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryUserProjects chains the current query on the "user_projects" edge.
func (uq *UserQuery) QueryUserProjects() *UserProjectQuery {
	query := (&UserProjectClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryUserServices chains the current query on the "user_services" edge.
func (uq *UserQuery) QueryUserServices() *UserServiceQuery {
	query := (&UserServiceClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryUserSkillAssociations chains the current query on the "user_skill_associations" edge.
func (uq *UserQuery) QueryUserSkillAssociations() *UserSkillAssociationQuery {
	query := (&UserSkillAssociationClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withExperiences:           uq.withExperiences.Clone(),
		withRepositories:          uq.withRepositories.Clone(),
		withUserProjects:          uq.withUserProjects.Clone(),
		withUserServices:          uq.withUserServices.Clone(),
		withUserSkillAssociations: uq.withUserSkillAssociations.Clone(),
...
func (uq *UserQuery) WithExperiences(opts ...func(*ExperienceQuery)) *UserQuery {
	query := (&ExperienceClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withExperiences = query
	return uq
}
...
// WithUserProjects tells the query-builder to eager-load the nodes that are connected to
// the "user_projects" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithUserProjects(opts ...func(*UserProjectQuery)) *UserQuery {
	query := (&UserProjectClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withUserProjects = query
	return uq
}

// WithUserServices tells the query-builder to eager-load the nodes that are connected to
// the "user_services" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithUserServices(opts ...func(*UserServiceQuery)) *UserQuery {
	query := (&UserServiceClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withUserServices = query
	return uq
}

// WithUserSkillAssociations tells the query-builder to eager-load the nodes that are connected to
// the "user_skill_associations" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithUserSkillAssociations(opts ...func(*UserSkillAssociationQuery)) *UserQuery {
	query := (&UserSkillAssociationClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withUserSkillAssociations = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	var (
		...
		loadedTypes = [6]bool{
			...
			uq.withExperiences != nil,
			uq.withRepositories != nil,
			uq.withUserProjects != nil,
			uq.withUserServices != nil,
			uq.withUserSkillAssociations != nil,
		}
	)
	...
	if query := uq.withExperiences; query != nil {
		if err := uq.loadExperiences(ctx, query, nodes,
	...
	if query := uq.withUserProjects; query != nil {
		if err := uq.loadUserProjects(ctx, query, nodes,
			func(n *User) { n.Edges.UserProjects = []*UserProject{} },
			func(n *User, e *UserProject) { n.Edges.UserProjects = append(n.Edges.UserProjects, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withUserServices; query != nil {
		if err := uq.loadUserServices(ctx, query, nodes,
			func(n *User) { n.Edges.UserServices = []*UserService{} },
			func(n *User, e *UserService) { n.Edges.UserServices = append(n.Edges.UserServices, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withUserSkillAssociations; query != nil {
		if err := uq.loadUserSkillAssociations(ctx, query, nodes,
			func(n *User) { n.Edges.UserSkillAssociations = []*UserSkillAssociation{} },
			func(n *User, e *UserSkillAssociation) {
				n.Edges.UserSkillAssociations = append(n.Edges.UserSkillAssociations, e)
			}); err != nil {
			return nil, err
		}
	}
...
func (uq *UserQuery) loadExperiences(ctx context.Context, query *ExperienceQuery, nodes []*User, init func(*User), assign func(*User, *Experience)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (uq *UserQuery) loadRepositories(ctx context.Context, query *RepositoryQuery, nodes []*User, init func(*User), assign func(*User, *Repository)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(repository.FieldUserID)
	}
...
func (uq *UserQuery) loadUserProjects(ctx context.Context, query *UserProjectQuery, nodes []*User, init func(*User), assign func(*User, *UserProject)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.UserProject(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.UserProjectsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadUserServices(ctx context.Context, query *UserServiceQuery, nodes []*User, init func(*User), assign func(*User, *UserService)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(userservice.FieldUserID)
	}
	query.Where(predicate.UserService(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.UserServicesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadUserSkillAssociations(ctx context.Context, query *UserSkillAssociationQuery, nodes []*User, init func(*User), assign func(*User, *UserSkillAssociation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(userskillassociation.FieldUserID)
	}
	query.Where(predicate.UserSkillAssociation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.UserSkillAssociationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
